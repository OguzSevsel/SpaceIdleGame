...
public class ProgressBar : MonoBehaviour
{
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Linear Progress Bar Rectangle White"));
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Linear Progress Bar Rounded Blue"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Linear Progress Bar Rounded Pink"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Linear Progress Bar Rounded White"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Radial Progress Bar Iconed"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Radial Progress Bar Iconed With Border"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Radial Progress Bar Full Blue"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Radial Progress Bar Full White With Border"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
    ...
    {
        GameObject obj = Instantiate(Resources.Load<GameObject>("UI/Progress_Bars/Radial Progress Bar Full White"));
        obj.transform.SetParent(Selection.activeGameObject.transform, false);
    }
#endif
